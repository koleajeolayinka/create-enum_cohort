...
const CohortCreationModal: React.FC<CohortCreationModalProps> = ({ setShowCohortForm }) => {
            ...
            <ScrollArea className="h-[75%] rounded-lg">
                <div className="bg-white rounded-lg p-8 w-[631px] px-[40px] py-[30px] grid gap-[10px] ">
                    <div className={'flex items-center content-between gap-[35px]'}>
                        <h2 className={`text-xl font-bold w-[500px] h-[31px] text-enumGray2 ${ibmPlexSerif.className}`}>
                            Create a Cohort
                        </h2>
                    ...
                    <Form {...form}>
                        ...
                        <div className={'mb-4'}>
                            <label htmlFor="" className={'block text-gray-700 font-medium m-2'}>
                                Programs
                            </label>
                            <Select
                            ...
                            >
                                ...
                                <SelectContent>
                                    <SelectGroup>
                                        ...
                                        <SelectItem value="productDesigner">Product Designer</SelectItem>
                        ...
                        <label htmlFor="file-upload" className={'block text-gray-700 font-medium m-2'}>
                            Add a cohort avatar
                        </label>
